...
export const sideTasks: string[] = [
  ...
  "Tape, stick, or pin something to Tyler Tracy, Cody Rushing, Parv Mahajan",
  "Get two other players to swap an item of clothing with each other",
  ...
  "Successfully lie about what you do for work to at least 3 different other players",
  "Leave a mysterious handwritten note in another player's pocket or bag",
  "Make up a fake scaling lab and convice another player you work there",
  "Convince another player you work on 'medium-stakes' control",
  "Get another player to say 'timelines' three times in a sentence",
  "Get another player to watch a video from last year's control conf",
  "Say 'your absolutely right' three times in a row",
  "wear five hats in front of 5 other players",
  ...
  "Re-explain the same thing to another player three times in a slightly different way",
  ...
  "Convince 5 other players to sing happy birthday to another player whose birthday isn't today",
