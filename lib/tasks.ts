...
export const sideTasks: string[] = [
  ...
  "Tape, stick, or pin something to Tyler Tracy, Cody Rushing, Parv Mahajan, or Buck Shlegeris",
  ...
  "Get Aryan / Cody / Tyler / Parv / Buck to give you carrer advice",
  ...
  "Get Tyler Tracy / Cody Rushing / Parv Mahajan / Buck Shlegeris to tell you 'I love you'",
